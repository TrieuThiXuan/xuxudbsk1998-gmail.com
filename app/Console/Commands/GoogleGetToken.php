...
class GoogleGetToken extends Command
{
    ...
    public function handle()
    {
        ...
        $credentialsPath = config('google_api.token_path'); // lấy đường dẫn đến token cũ
...
// hàm get token
    ...
    private function getClient()
    {
        ...
        $client->setAuthConfig(config('google_api.client_path')); // đường dẫn đến file credentials.json
